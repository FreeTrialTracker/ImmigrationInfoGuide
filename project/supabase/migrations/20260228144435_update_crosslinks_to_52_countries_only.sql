/*
  # Update country_crosslinks to only include 52 verified VisaInfoGuide countries

  1. Changes
    - Clear all existing mappings
    - Insert only the 52 countries that exist on VisaInfoGuide
    - Map visa_slug to corresponding immigration slug where available
    - Set is_active = true for all 52 countries

  2. Notes
    - All URLs follow the pattern: https://visainfoguide.com/destination/{slug}
    - Immigration URLs use immigrate-to/{slug} pattern
    - Some slugs differ between sites (e.g., us vs united-states)
*/

-- Clear all existing mappings
DELETE FROM country_crosslinks;

-- Insert the 52 verified VisaInfoGuide countries
INSERT INTO country_crosslinks (visa_slug, visa_url, immigration_url, is_active) VALUES
  ...
  ('australia', 'https://visainfoguide.com/destination/australia', 'https://immigrationinfoguide.com/immigrate-to/au', true),
  ...
  ('canada', 'https://visainfoguide.com/destination/canada', 'https://immigrationinfoguide.com/immigrate-to/ca', true),
  ...
  ('new-zealand', 'https://visainfoguide.com/destination/new-zealand', 'https://immigrationinfoguide.com/immigrate-to/nz', true),
  ...
  ('united-kingdom', 'https://visainfoguide.com/destination/united-kingdom', 'https://immigrationinfoguide.com/immigrate-to/gb', true),
  ('united-states', 'https://visainfoguide.com/destination/united-states', 'https://immigrationinfoguide.com/immigrate-to/us', true),
